...
//		$this->connect->restrict('editors');
	...
	/**
	 * Prints out the extend fields list and form
	 ...
	 * @return 	String		HTML extend fields list
	 *
	 */
			...
			else
			{
				...
				if ($this->input->post('parent') !='')
				{
					$this->update[] = array(
						...
						'url' =>  'admin/extend_field/get_element_extend_fields_table/'.$this->input->post('parent')
					);
				}
			...
			if ($this->extend_field_model->delete($id) > 0)
			{
				...
				if ( $parent !== false)
				{
					$this->update[] = array(
						...
						'url' =>  'admin/extend_field/get_element_extend_fields_table/'.$parent
					);
				}
