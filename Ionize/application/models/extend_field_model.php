...
//	protected $got_extend_fields_def = false;	// Did we already got the extend fields definition ?
	
//	protected $extend_fields_def = array();		// Array of extend fields for this kind od object
	...
	function get_element_extend_fields($parent, $id_parent=null)
	{
		...
		$this->db->where(array('parent'=>$parent, 'id_parent' => $id_parent));
