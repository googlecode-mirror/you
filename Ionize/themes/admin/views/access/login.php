...
<head>
	...
	<script type="text/javascript" src="<?=base_url()?>themes/admin/javascript/mootools-1.2.3-core-yc.js"></script>
	<script type="text/javascript" src="<?=base_url()?>themes/admin/javascript/mootools-1.2.3.1-more-yc.js"></script>

	<link rel="stylesheet" href="<?= base_url().('themes/admin/css/login.css') ?>" type="text/css" />
