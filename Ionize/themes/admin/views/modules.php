				...
				<tr class="module<?= $module['name'] ?>">
					<td>
						<?php if($module['has_admin'] == 'true'): ?>
							<a class="moduleAdminLink" href="admin/module/<?= $module['folder'] ?>/<?= $module['uri_segment'] ?>/index" rel="<?= $module['name'] ?>" id="module<?= $module['name'] ?>"><?= $module['name'] ?></a>
						<?php else :?>
							<?= $module['name'] ?>
						<?php endif; ?>
					</td>
					...
					<td><img src="<?=base_url()?>themes/admin/images/icon_16_<?php if($module['installed']): ?>ok<?php else: ?>nok<?php endif; ?>.png" /></td>
					<td>
						<?php if($module['installed']): ?>
							<a class="moduleUninstall" href="<?=base_url()?>admin/modules/uninstall/<?= $module['folder'] ?>"><?= lang('ionize_label_module_uninstall') ?>
						<?php else :?>
							<a class="moduleInstall" rel="<?= $module['folder'] ?>" href="<?=base_url()?>admin/modules/install/<?= $module['folder'] ?>"><?= lang('ionize_label_module_install') ?>
						<?php endif; ?>
					</td>
				</tr>
