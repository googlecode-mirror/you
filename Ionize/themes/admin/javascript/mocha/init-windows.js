...
/// HERE
/// Create the modal error window with just a little OK button and a nice icon
	 ...
	 *
	 * @param	string		Window ID
	 * @param	string		Window Form name
	 * @param	string		Lang translation key or string as title of the window
	 * @param	string		URL called in case of positive user answer
	 * @param	object		Window extended options
	 *
	 */
	MUI.formWindow = function(id, form, title, wUrl, wOptions)
	{
		...
		var options  = 
		{
			...
			onContentLoaded: function(c)
			{
				...
				// Set the form submit button action and send the DOMElement to updat with the according URL
