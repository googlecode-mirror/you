...
define("CALLBACK_FUNCTION", 'mediaManager.addMedia');
require_once('config.ionize.php');

define("WN_URL",$base_url);//your domain url
define('WN_PATH',$site_path);//domain root absolute path 

define("IMG_PATH",WN_PATH.$picture_path);		// Image dir url 
define('IMG_URL',WN_URL.$picture_path);			// Image dir absolute path 
define('FILE_PATH',WN_PATH.$file_path);			// File dir url 
define('FILE_URL',WN_URL.$file_path);			// File dir absolute path 
define('MEDIA_PATH',WN_PATH.$file_path);		// Media dir url 
define('MEDIA_URL',WN_URL.$file_path);			// Media dir absolute path 
	/**
	 * ezfilemanager array
...
$ezfilemanager['filetype']['file']  = array('html','pdf','ppt','txt','doc','rtf','xml','xsl','dtd','zip','rar','jpg','jpeg','flv','mp3','swf');
