...
function refreshBackLinks(){
	$refersh_back_icon ='<a href="'.$_SERVER['PHP_SELF'].'?'.$_SERVER['QUERY_STRING'].'" title="'.TXT_REFRESH.'" class="navicons"><img src="img/refresh.gif" width="16" height="16" alt="'.TXT_REFRESH.'" /></a><a href="'.$_SERVER['PHP_SELF'].'?type='.THE_TYPE.'&amp;sa='.STAND_ALONE.'" title="'. TXT_BACK.'" class="navicons"><img src="img/folder_up.gif" width="16" height="16"  alt="'.TXT_BACK.'"  /></a>';
if ($pos = strrpos(substr($_GET['thedir'], 0, -1), "/"))
		{
	$refersh_back_icon .='<a href="'. $_SERVER['PHP_SELF'].'?type='.THE_TYPE.'&amp;sa='.STAND_ALONE.'" title="'.TXT_ROOT.'" class="navicons"><img src="img/folder_root.gif" width="16" height="16" alt="'. TXT_ROOT.'" /></a>';
		}
