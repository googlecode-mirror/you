...
$lang['database_migration_from_090'] = 			'This database needs an upgrade.<br/>Upgrade from version : <b class="highlight2">0.90</b>';
$lang['database_migration_from_092'] = 			'This database needs an upgrade.<br/>Upgrade from version : <b class="highlight2">0.92</b>';
$lang['database_migration_from_093'] = 			'This database needs an upgrade.<br/>Upgrade from version : <b class="highlight2">0.93</b>';
$lang['database_migration_from_094'] = 			'This database needs an upgrade.<br/>Upgrade from version : <b class="highlight2">0.9.4</b>';
