...
$lang['database_migration_from_090'] = 			'Cette base de données nécessite une migration.<br/>Migration depuis la version : <b class="highlight2">0.90</b>';
$lang['database_migration_from_092'] = 			'Cette base de données nécessite une migration.<br/>Migration depuis la version : <b class="highlight2">0.92</b>';
$lang['database_migration_from_093'] = 			'Cette base de données nécessite une migration.<br/>Migration depuis la version : <b class="highlight2">0.93</b>';
$lang['database_migration_from_094'] = 			'Cette base de données nécessite une migration.<br/>Migration depuis la version : <b class="highlight2">0.9.4</b>';
